...
IEEE80211_IF_FILE(dot11MeshDelayedBeaconTxInterval,
		  u.mesh.mshcfg.dot11MeshConnectedToAuthServer, DEC);
IEEE80211_IF_FILE(dot11MeshDelayedBeaconTxMaxDelay,
		  u.mesh.mshcfg.dot11MeshConnectedToAuthServer, DEC);
IEEE80211_IF_FILE(dot11MeshDelayedBeaconTxMinDelay,
		  u.mesh.mshcfg.dot11MeshConnectedToAuthServer, DEC);		  		  	  
#endif
...
#define MESHPARAMS_ADD(name) \
	...
	MESHPARAMS_ADD(dot11MeshDelayedBeaconTxInterval);
	MESHPARAMS_ADD(dot11MeshDelayedBeaconTxMaxDelay);
	MESHPARAMS_ADD(dot11MeshDelayedBeaconTxMinDelay);
